...
object In_Hierarchy_Parent_Waits_Until_All_Children_Finished {
    ...
    fun main(args: Array<String>) = runBlocking {
        ...
        val parent = launch {
            ...
            invokeOnCompletion { println("parent: now, I am completed") }
        }
...
object In_Hierarchy_Parent_Waits_Until_All_Children_Finished_Other_Demo {
    ...
    fun main(args: Array<String>) = runBlocking {
        val parentJob = launch {
            ...
            invokeOnCompletion { println("Finally, parent finished ...") }
        }
        ...
        launch(parentJob) {
            ...
            invokeOnCompletion { println("\tChild finished after 1000") }
        }
