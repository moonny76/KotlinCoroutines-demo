...
import com.org.scarlet.mockk.MyObject.extensionInObject
import io.mockk.*
...
class M04_ExtensionFunctionTest {
    ...
    /**
     * You need to add mockkStatic("file-name-path") Make sure you add "Kt" at the end of the file name.
     * Note that this will mock the whole pkg.FileKt class, and not just extensionFunc.
     */
    @Test
    fun `top level extension function test`() {
//        mockkStatic("com.org.androidtestingkt.mockk.M04_ExtensionFunctionTestKt")
